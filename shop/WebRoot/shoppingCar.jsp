...
<body>
	...
	<div class="container">
		...
		<div>
			<span>我的购物车</span>
			<span>产品是否购买成功，以最终下单为准，请尽快结算</span>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
				    <h3>确定删除该商品？<span class="close" data-dismiss="modal">&times;</span></h3>
					<button class="btn btn-danger btn-lg" id="isDeleteOne">确定</button>
					<button class="btn btn-info btn-lg" data-dismiss="modal" id="noDeleteOne">取消</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="noProductModal" data-backdrop="static">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
				    <h3>没有选择任何商品噢！<span class="close" data-dismiss="modal">&times;</span></h3>
	...
	<div class="modal fade" id="balanceModal" data-backdrop="static">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
				    <h3>请先选择商品<span class="close" data-dismiss="modal">&times;</span></h3>
					<button class="btn btn-danger btn-lg" id="isBalance" style="margin-left: 43%">确定</button>
				</div>
			</div>
		</div>
	</div>
