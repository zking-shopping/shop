  ...
  <body>
		...
		<div class="content">
			<container>
				<div class="left">
					<ul>
						...
						<li>
							<h3>下载中心</h3>
							<div class="title">
								<p style="background : yellow;"><a>商品数据下载</a></p>
							</div>
						</li>
					</ul>
				</div>
				<div class="right">
					<ul>
						<li><a href="admin/upload.do">点击下载网站后台管理操作演示文档</a></li>
						<li><a href="admin/upload.do">点击下载商品信息文档</a></li>
						<li><a href="admin/upload.do">点击下载商品类型文档</a></li>
						<li><a href="admin/upload.do">点击下载商品点击量文档</a></li>
						<li><a href="admin/upload.do">点击下载商品购买量文档</a></li>
					</ul>
				</div>
			</container>
		</div>
...
var f = function(){
	$('.left>ul>li>h3').eq(5).css('background-color', 'red').siblings('.title').show().parent('li').siblings('li').children('.title').hide().siblings('h3').css('background-color', 'blue');;
}
(f)();
</script>